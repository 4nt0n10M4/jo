...
class CodeCommand extends Command {
    constructor(){
        super({
            ...
            args: [new CommandArg({name: 'intructions', description: 'Instructions to code', required: true, type: "content"})]
        });
    }
    ...
    if (!process.env.CODEX_TOKEN) return call.reply({content: 'No codex token found'});
    const headers = {
